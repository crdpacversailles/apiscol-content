						...
						<th colspan="12">
							...
							<xsl:call-template name="page_number">
								<xsl:with-param name="total"
									select="*[local-name()='totalResults']"></xsl:with-param>
								<xsl:with-param name="start"
									select="*[local-name()='startIndex']"></xsl:with-param>
								<xsl:with-param name="rows"
									select="*[local-name()='itemsPerPage']"></xsl:with-param>
							</xsl:call-template>
						</th>
					</tr>
				</thead>
						...
						<td colspan="12">
							<xsl:call-template name="pagination">
								<xsl:with-param name="length"
									select="*[local-name()='totalResults']">
								</xsl:with-param>
